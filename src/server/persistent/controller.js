const titter = require("../utils/titterClient"),
...
class ChessController
{
    constructor() {
        this.db = {};
        this.infoText= 'Visit https://chess.wrioos.com for info.',
        this.chessUrl= 'https://chess' + nconf.get("server:workdomain");
    ...
    userAccessRequestCallback (args) {
        var $ = this,
            args = args || {},
            uuid = args.uuid || '',
            uuids = $.db.collection('chess_uuids'),
    ...
    opponentAccessRequestCallback (args) {
        var $ = this,
            args = args || {};
        return new Promise(function(resolve, reject) {
            args.db = $.db;
